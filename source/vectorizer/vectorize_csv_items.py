...
# Xử lý file CSV thành dạng text #####################################
...
data_text = csv2txt('D:/Chatbot_langchains_openAI/data/data_csv/204_final_edited.csv')
...
db.save_local("D:/Chatbot_langchains_openAI/vectorstore/store_204_items")